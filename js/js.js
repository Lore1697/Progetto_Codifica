$(document).ready(function(){
  ...
  var s = ' ';
  var div_img = selected + s + '.container-manoscritto__img';
  var i_fronte = selected + s + '.trascrizione';
  var i_retro = selected + s + '.retro';
  var t_fronte = selected + s + '.container-manoscritto__testo__fronte';
  var t_retro = selected + s + '.container-manoscritto__testo__retro';
  var t_dati = selected + s + '.container-manoscritto__testo__dati-tecnici';
